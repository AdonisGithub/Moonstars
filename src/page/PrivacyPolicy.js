...
<div className=" w-full bg-black">
      <div className="flex w-full px-11">
        <div className="w-full text-white py-10">
            ...
            <div className="flex font-bold text-2xl my-3">
                THEMOONSTAS OPERATES THE THEMOONSTAS.COM WEBSITE, WHICH PROVIDES THE SERVICE.
            </div>
            <div className="text-xl">
                This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the themoonstas website.
            </div>
            <div className="text-xl">
            ...
            <div className="text-xl">
                The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at themoonstas.com, unless otherwise defined in this Privacy Policy.
            </div>
