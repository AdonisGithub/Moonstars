...
const Whatisthemoonstars = () => {
  return (
    <div className=" w-full" id="whatisthemoonstars">
        <div className="text-[25px] sm:text-[43px] md:text-[52px] lg:text-[72px] leading-tight font-extrabold mt-14 mb-5 px-11">
            ...
            <div className="text-white">THE MOONSTARS?</div>                    
        </div>
        <div className="w-full grid lg:grid-cols-2">
            <div className=" w-full flex justify-start">
                <div>
                    ...
                    <div className="text-[16px] sm:text-[22px] md:text-[24px] lg:text-[28px] text-white  font-extrabold mb-5 px-11">
                        EACH MOONSTRA IS COMPLETELY UNIQUE BASED ON OVER <span className="customFont">500</span> TRAITS, INCLUDING SKILLS, ACCESSORIES, SKINS, ETC...
                    </div>
                    <div className="text-[16px] sm:text-[22px] md:text-[24px] lg:text-[28px] text-white  font-extrabold mb-5 px-11">
                    ...
                    <div className=" text-[16px] sm:text-[22px] md:text-[24px] lg:text-[28px] text-white  font-extrabold px-11">
                        <div>ENTERING THE MOONSTARS COMMUNITY MEANS GETTING THE <span className="customFont">KEY</span> TO A FULL UNIVERSE OF POSSIBILITIES ALWAYS BASED ON <span className="customFont">TRANSPARENCY</span> AND <span className="customFont">HONESTY.</span></div>   
                    </div>
                </div>
            </div>    
